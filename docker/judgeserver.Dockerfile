...
COPY src/judgeserver/run.sh /judge/server/run.sh
COPY src/judgeserver/check_nacos.sh /judge/server/check_nacos.sh
COPY src/judgeserver/testlib.h /usr/include/testlib.h
ADD src/judgeserver/Sandbox-amd64 /judge/server/Sandbox-amd64
ADD src/judgeserver/Sandbox-arm64 /judge/server/Sandbox-arm64
